    ...
    <div style={{ minHeight:'100vh', background: isHome||isLogin ? '#3D5570' : 'var(--bg)' }}>
      ...
      <AppErrorBoundary>
        <Routes>
          ...
          <Route path="/radar/clients" element={<RequireAuth><ClientList clients={clients} onAddClient={addClient} onUpdateClients={updateAllClients} /></RequireAuth>} />
          ...
          <Route path="/radar/clients/:name/loan/:loanIdx/maf" element={<RequireAuth><MafFacility clients={clients} updateClient={updateClient} /></RequireAuth>} />
          <Route path="/radar/clients/:name/loan/:loanIdx/maf/parcel/:parcelIdx" element={<RequireAuth><MafParcel clients={clients} updateClient={updateClient} /></RequireAuth>} />
          ...
          <Route path="/radar/direct-income" element={<RequireAuth><DirectIncome /></RequireAuth>} />
          <Route path="/radar/direct-income/:id" element={<RequireAuth><DirectIncomeInvoice /></RequireAuth>} />
