...
export function emailFooter(brokerName, brokerPhone) {
  return `
    </div>
    <div style="background:#3D4F6B;padding:22px 40px;text-align:center">
